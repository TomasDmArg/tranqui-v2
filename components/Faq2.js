...
const charactersList = [
...

  {
    ...
    content: (
      <ul>
        ...
        <li>
          Presencia de cuadro psicopatológico (en especial: depresión mayor,
  ...
  },
  {
    ...
    content: (
      <ul>
        <li>
          Ideación suicidas: presencia, contenido, intensidad, frecuencia,
          duración.
        </li>
        <li>
          Plan suicida: grado de planeación vinculado a cómo llevarlo a cabo.
        </li>
        <li>
          Intento previo: presencia, método utilizado, circunstancias que
          rodearon el acto.
        </li>
